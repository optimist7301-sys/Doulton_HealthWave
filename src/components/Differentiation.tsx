    ...
    <section className="py-24 bg-paper border-t border-line overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-brand-deep mb-6">
            Doulton Healthwave만의 <br />
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <motion.div
            ...
            viewport={{ once: true }}
            className="p-10 rounded-[32px] bg-white border border-line shadow-sm hover:shadow-xl transition-all group"
          >
